...
-------------------------------------------------------------------------------
-- Emitted on: Tue Jun 24 05:06:58 1997
...
PACKAGE BODY TCPIPSockets IS
   ...
   TCPIPSocketsClassData : classData;
   FOR TCPIPSocketsClassData USE AT standard.system.label("TCPIPSocketsClassData");
   ...
   TCPIPSocketsCClassData : CClassData;
   FOR TCPIPSocketsCClassData USE AT standard.system.label("TCPIPSocketsCClassData");
   ...
   BEGIN
      IF 
         SOMObject.somIsA(
            ...
            TCPIPSocketsClassData.classObject) 
      THEN
   ...
   FUNCTION New_Class (
      ...
      RETURN             SOM.SOMClassPtr
   IS
      FUNCTION TCPIPSocketsNewClass (
         Major_Version : IN SOM.integer4;
         Minor_Version : IN SOM.integer4)
         RETURN             SOM.SOMClassPtr;
      PRAGMA interface (C, TCPIPSocketsNewClass);
      PRAGMA interface_information (TCPIPSocketsNewClass, ".TCPIPSocketsNewClass");
   BEGIN
      RETURN TCPIPSocketsNewClass(major_version, minor_version);
   END New_Class;
   ...
   BEGIN
      IF TCPIPSocketsClassData.classObject = SOM.null_address THEN
         Dummy := New_Class(Major_Version, Minor_Version);
      END IF;
      Result.som_object := 
         SOMClass.somNew(
            SOMClass.To_Ref(TCPIPSocketsClassData.classObject));
      RETURN Result;
   END New_Instance;
